...
<body>
    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#"><i class="fa fa-map-marked-alt"></i> Site Management</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="fa fa-users"></i> Group Management</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="h3">Site Management</h1>
            <a href="add-site.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add Site</a>
        </div>
    ...
    <script>
        $(document).ready(function () {
            $(".delete").click(function () {
                let choice = confirm("Are you sure you want to delete this site?");
                if (choice === true) {
                    let row = $(this).closest("tr");
                    $(row).fadeOut(1000, function () {
                        $(row).remove();
                        $("#message").text("Site deleted successfully.").show().delay(3000).fadeOut();
                    });
                }
            });

            // Search function (example implementation)
            $("#siteSearch").on("keyup", function () {
                var value = $(this).val().toLowerCase();
                $("#site-table-body tr").filter(function () {
